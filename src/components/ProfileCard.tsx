...
const ProfileCard = () => {
  return (
    <div className="flex items-center gap-8 max-w-2xl m-8">
      <div className="flex flex-col gap-8 items-center rounded-xl shadow-lg bg-[#F8F3F0] px-10 py-8">
        <img
      ...
      <div className="flex flex-col gap-4 w-82">
        <h1 className="font-sans text-6xl">Hello</h1>
        ...
        <p>
          ...
          översättning och foto. Några av de jobb jag har gjort hittar du längre
          ner.
        </p>
        <p>
